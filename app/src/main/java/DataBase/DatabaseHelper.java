...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_PHONE + " INTEGER," + COLUMN_USER_PASSWORD + " TEXT" + ")";
    ...
    /*private void saveToDB() {
        ...
        ContentValues values = new ContentValues();
        values.put(DatabaseHelper.COLUMN_USER_NAME, activityBinding.nameEditText.getText().toString());
        values.put(DatabaseHelper.COLUMN_USER_PASSWORD, activityBinding.ageEditText.getText().toString());
        long newRowId = database.insert(DatabaseHelper.TABLE_USER, null, values);

        Toast.makeText(DatabaseHelper.this, "The new Row Id is " + newRowId, Toast.LENGTH_LONG).show();
    }

    private void readFromDB() {
        String name = activityBinding.nameEditText.getText().toString();
        String password = activityBinding.passWordEditText.getText().toString();
        ...
        String selection =
                DatabaseHelper.COLUMN_USER_NAME + " like ? and " +
                        DatabaseHelper.COLUMN_USER_PASSWORD + " > ? and ";

        String[] selectionArgs = {"%" + name + "%" + password + "%"};

        Cursor cursor = database.query(
                DatabaseHelper.COLUMN_USER_NAME,   // The table to query
